(function () {
    function a(a) {
        (this.tokens = []),
            ...
            (this.rules = i.normal),
            this.options.gfm && (this.options.tables ? (this.rules = i.tables) : (this.rules = i.gfm));
    }
    function b(a, b) {
        ...
        this.options.gfm
            ? this.options.breaks
                ? (this.rules = j.breaks)
                : (this.rules = j.gfm)
            : this.options.pedantic && (this.rules = j.pedantic);
    }
    function c(a) {
    ...
    (i.bullet = /(?:[*+-]|\d+\.)/),
        ...
        (i.html = e(i.html)("comment", /<!--[\s\S]*?-->/)("closed", /<(tag)[\s\S]+?<\/\1>/)(
            "closing",
            /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/
        )(/tag/g, i._tag)()),
        (i.paragraph = e(i.paragraph)("hr", i.hr)("heading", i.heading)("lheading", i.lheading)(
            "blockquote",
            i.blockquote
        )("tag", "<" + i._tag)("def", i.def)()),
        (i.normal = g({}, i)),
        ...
        (a.prototype.token = function (a, b) {
            for (var c, d, e, f, g, h, j, k, l, a = a.replace(/^ +$/gm, ""); a; )
                if (
                    ((e = this.rules.newline.exec(a)) &&
                        ((a = a.substring(e[0].length)), e[0].length > 1 && this.tokens.push({ type: "space" })),
                    (e = this.rules.code.exec(a)))
                )
                    (a = a.substring(e[0].length)),
                        (e = e[0].replace(/^ {4}/gm, "")),
                        this.tokens.push({ type: "code", text: this.options.pedantic ? e : e.replace(/\n+$/, "") });
                    ...
                    (a = a.substring(e[0].length)),
                        this.tokens.push({ type: "heading", depth: e[1].length, text: e[2] });
                    ...
                    (a = a.substring(e[0].length)),
                        this.tokens.push({ type: "heading", depth: "=" === e[2] ? 1 : 2, text: e[1] });
                    ...
                    for (
                        a = a.substring(e[0].length),
                            f = e[2],
                            this.tokens.push({ type: "list_start", ordered: f.length > 1 }),
                        ...
                        (h = e[k]),
                            ...
                            ~h.indexOf("\n ") &&
                                ...
                                (h = this.options.pedantic
                                    ? h.replace(/^ {1,4}/gm, "")
                                    : h.replace(new RegExp("^ {1," + j + "}", "gm"), ""))),
                            this.options.smartLists &&
                                k !== l - 1 &&
                                ((g = i.bullet.exec(e[k + 1])[0]),
                                f === g ||
                                    (f.length > 1 && g.length > 1) ||
                                    ((a = e.slice(k + 1).join("\n") + a), (k = l - 1))),
                            (d = c || /\n\n(?!\s*$)/.test(h)),
                            k !== l - 1 && ((c = "\n" === h[h.length - 1]), d || (d = c)),
                    ...
                    (a = a.substring(e[0].length)),
                        (this.tokens.links[e[1].toLowerCase()] = { href: e[2], title: e[3] });
    ...
    (j._inside = /(?:\[[^\]]*\]|[^\]]|\](?=[^\[]*\]))*/),
            ...
            for (var b, c, e, f, g = ""; a; )
                if ((f = this.rules.escape.exec(a))) (a = a.substring(f[0].length)), (g += f[1]);
                    ...
                    (a = a.substring(f[0].length)),
                        "@" === f[2]
                            ? ((c = ":" === f[1][6] ? this.mangle(f[1].substring(7)) : this.mangle(f[1])),
                              (e = this.mangle("mailto:") + c))
                            : ((c = d(f[1])), (e = c)),
                        (g += '<a href="' + e + '">' + c + "</a>");
                    ...
                    if (
                        ((a = a.substring(f[0].length)),
                        (b = (f[2] || f[1]).replace(/\s+/g, " ")),
                        (b = this.links[b.toLowerCase()]),
                        !b || !b.href)
                    ) {
        ...
        (b.prototype.mangle = function (a) {
            for (var b, c = "", d = a.length, e = 0; d > e; e++)
                (b = a.charCodeAt(e)), Math.random() > 0.5 && (b = "x" + b.toString(16)), (c += "&#" + b + ";");
            return c;
        }),
            ...
            switch (this.token.type) {
                ...
                case "table":
                    ...
                    for (h += "<thead>\n<tr>\n", c = 0; c < this.token.header.length; c++)
                        (b = this.inline.output(this.token.header[c])),
                            (h += this.token.align[c]
                                ? '<th align="' + this.token.align[c] + '">' + b + "</th>\n"
                                : "<th>" + b + "</th>\n");
                    for (h += "</tr>\n</thead>\n", h += "<tbody>\n", c = 0; c < this.token.cells.length; c++) {
                        for (e = this.token.cells[c], h += "<tr>\n", g = 0; g < e.length; g++)
                            (f = this.inline.output(e[g])),
                                (h += this.token.align[g]
                                    ? '<td align="' + this.token.align[g] + '">' + f + "</td>\n"
                                    : "<td>" + f + "</td>\n");
                        h += "</tr>\n";
                    }
                    return (h += "</tbody>\n"), "<table>\n" + h + "</table>\n";
    ...
    (function (a) {
        ...
        a("html").addClass("md-hidden-load"),
            (a.md = function (b) {
                return a.md.publicMethods[b]
                    ? a.md.publicMethods[b].apply(this, Array.prototype.slice.call(arguments, 1))
                    : void a.error("Method " + b + " does not exist on jquery.md");
            }),
            (a.md.config = {
                title: null,
                useSideMenu: !0,
                    ...
                    d.outstanding.push(f),
                        a.md.util.wait(2500).done(function () {
                            "resolved" !== f.state() &&
                                ...
                                b.fatal("stage " + c + " failed running subscribed function: " + e));
                        });
                    var g = function () {
                        f.resolve();
                    };
    ...
    (function (a) {
        ...
        function b() {
            (a.md.stages = [
                ...
                (a.md.stage = function (b) {
                    var c = a.grep(a.md.stages, function (a, c) {
                        return a.name === b;
                    });
        ...
        function d(b) {
            ...
            "original" === a.md.config.lineBreaks
                ? (c.breaks = !1)
                : "gfm" === a.md.config.lineBreaks && (c.breaks = !0),
                marked.setOptions(c);
            var d = marked(b);
            return d;
        }
            ...
            a.md.stage("init").subscribe(function (c) {
                ...
                a.ajax(d)
                    ...
                    .fail(function () {
                        ...
                        e.warn("Could not get " + a.md.mainHref),
                            (d.url = "404.md"),
                            a
                                .ajax(d)
                                .done(function (a) {
                                ...
                                .fail(function (a) {
                                    e.fatal("Could not get a user defined 404.md"), (b = "# Page Not Found"), c();
                                });
                    });
            }),
                        ...
                        .done(function (b) {
                            ...
                            if (i.startsWith("preview:")) {
                                var g = parseInt(i.substring(8), 10) || 3,
                                    j = e(c, g);
                                j.last().append('<a href="' + h + '"> ...read more &#10140;</a>'),
                                    j.insertBefore(f.parent("p").eq(0)),
                                    f.remove();
            ...
            void 0 === c && (c = ""),
                ...
                d.find("a, img").each(function (b, d) {
                    ...
                    if (
                        ...
                        a.md.util.isRelativeUrl(j) &&
                            (!h || a.md.util.isRelativePath(j)) &&
                            (h || !a.md.util.isGimmickLink(f)))
                    ) {
                        var k = c + j;
        ...
        function k() {
            a.md.stage("init").subscribe(function (b) {
                a("#md-all").empty();
                var c =
                    '<div id="md-body"><div id="md-title"></div><div id="md-menu"></div><div id="md-content"></div></div>';
        ...
        function m() {
            a.md.stage("init").done(function () {
                ...
                a.md.stage("all_ready").done(function () {
                    a("html").removeClass("md-hidden-load"),
                        "function" == typeof window.callPhantom && window.callPhantom({}),
                        a.md.stage("final_tests").run();
                }),
        ...
        function n() {
            var b;
            (b = window.location.hash.startsWith("#!")
        ...
        function o() {
            ...
            "" === b || "#" === b || "#!" === b
                ? (a = "#!index.md")
                : b.startsWith("#!") && b.endsWith("/") && (a = b + "index.md"),
        ...
        a
            ...
            a
                ...
                .done(function (b) {
                    try {
                        var c = JSON.parse(b);
                        (a.md.config = a.extend(a.md.config, c)),
                            p.info("Found a valid config.json file, using configuration");
                    } catch (d) {
    ...
    (function ($) {
            ...
            if (-1 === $.inArray(a, licenses)) {
                ...
                "OTHER" === a &&
                    log.warn(
                        "WARNING: Module " +
                            b.name +
                            " uses a script with unknown license. This may be a GPL license violation if this website is publically available!"
                    );
        }
                ...
                $.md.stage(f).subscribe(function (a) {
                    c.startsWith("//") || c.startsWith("http")
                        ? $.getScript(c, function () {
                              void 0 !== h ? h(a) : (log.debug("module" + b.name + " script load done: " + c), a()),
                                  i.resolve();
                          })
                        : (insertInlineScript(c),
                          log.debug("module" + b.name + " script inject done"),
                          i.resolve(),
                          a());
                }),
        ...
        function loadRequiredScripts() {
            $.each(activeLinkTriggers, function (a, b) {
                ...
                if (void 0 === c)
                    return void log.error('Gimmick link: "' + b + '" found but no suitable gimmick loaded');
        ...
        function getGimmickLinkParts($link) {
            ...
            if (null === matches || void 0 === matches[1])
                return $.error("Error matching a gimmick: " + link_text), null;
            var trigger = matches[1].toLowerCase(),
                args = null;
            if (void 0 !== matches[2]) {
                var params = $.trim(matches[3].toString());
                "}" === params.charAt(params.length - 1) && (params = params.substring(0, params.length - 1)),
                    (params = "({" + params + "})"),
        ...
        function subscribeLinkTrigger(a, b, c) {
            log.debug("Subscribing gimmick " + c.module.name + " to stage: " + c.stage),
                $.md.stage(c.stage).subscribe(function (d) {
                    (b.options = b.options || {}),
                        jQuery.contains(document.documentElement, a[0]) ||
                            (log.error("LINK IS NOT IN THE DOM ANYMORE: "), console.log(a)),
    ...
    (function (a) {
        function b() {
            var b;
            if (
                (a.md.config.title && a("title").text(a.md.config.title),
                (b = a("#md-content h1").eq(0)),
                a.trim(b.toptext()).length > 0)
            ) {
            ...
            a("#md-content p").each(function () {
                ...
                if (0 !== a.trim(b.text()).length) {
                    var c = b.contents().filter(function () {
                            var b = a(this);
                            return "A" === this.tagName && b.find("img").length > 0
                                ? !0
                                : "IMG" === this.tagName
                                ? !0
                                : !1;
                        ...
                        d = e(b);
                    b.wrapInner('<div class="md-text" />'),
                        0 !== c.length && (c.prependTo(b), b.addClass("md-floatenv").addClass(d));
                }
            });
        }
        function d() {
        ...
        function e(b) {
            var c = a(b),
                ...
                e = c.contents().filter(function () {
                    return "IMG" === this.tagName || "IFRAME" === this.tagName
                        ? !0
                        : "A" === this.tagName
                        ? a(this).find("img").length > 0
                        : a.trim(a(this).text()).length > 0;
                }),
                f = e[0];
            return (
                void 0 !== f &&
                    null !== f &&
                    (d =
                        "IMG" === f.tagName || "IFRAME" === f.tagName
                            ? "md-float-left"
                            : "A" === f.tagName && a(f).find("img").length > 0
                            ? "md-float-left"
                            : "md-float-right"),
                d
            );
        ...
        function g() {
            function b() {
                return (c = a("img").filter(function (b) {
                    var c = a(this).parents("a").eq(0);
    ...
    (function (a) {
            ...
            if (0 !== a("#md-menu a").length) {
                ...
                c
                    ...
                    a("#md-menu hr").each(function (b, c) {
                        ...
                        e.is("ul") &&
                            e.length >= 0 &&
                            (e.append(a('<li class="divider"/>')),
                            d.remove(),
                            f.is("ul") && (f.find("li").appendTo(e), f.remove()));
                    }),
        ...
        function g() {
            ...
            if ((b.children().remove(), !(b.length <= 1))) {
                a("#md-content").removeClass("col-md-12"),
                    a("#md-content").addClass("col-md-9"),
                    a("#md-content-row").prepend('<div class="col-md-3" id="md-left-column"/>');
                var c = function () {
                ...
                a(window).scroll(function () {
                    ...
                    a("*.md-inpage-anchor").each(function (c, d) {
                        ...
                        a("#md-page-menu a").each(function (c, d) {
                            ...
                            b &&
                                e.toptext() === b.toptext() &&
                                (a("#md-page-menu a.active").removeClass("active"), e.addClass("active"));
                        });
                });
        ...
        (a.mdbootstrap = function (b) {
            return a.mdbootstrap.publicMethods[b]
                ? a.mdbootstrap.publicMethods[b].apply(this, Array.prototype.slice.call(arguments, 1))
                : void a.error("Method " + b + " does not exist on jquery.mdbootstrap");
        }),
                ...
                bootstrapify: function () {
                    h(),
                        ...
                        a.md.stage("pregimmick").subscribe(function (b) {
                            a.md.config.useSideMenu !== !1 && g(), m(), b();
                        }),
                        a.md.stage("postgimmick").subscribe(function (a) {
                            l(), j(), a();
                        });
        ...
        a.mdbootstrap.publicMethods = a.extend({}, a.mdbootstrap.publicMethods, o);
    })(jQuery),
    (function (a) {
        a.gimmicks = a.fn.gimmicks = function (b) {
            return void 0 !== b
                ? a.fn.gimmicks.methods[b]
                    ? a.fn.gimmicks.methods[b].apply(this, Array.prototype.slice.call(arguments, 1))
                    : void a.error("Gimmick " + b + " does not exist on jQuery.gimmicks")
                : void 0;
        };
    })(jQuery),
    (function (a) {
        function b() {
            ...
            b.each(function () {
                ...
                b.addClass("alert"),
                    "note" === c
                        ? b.addClass("alert-info")
                        : "hint" === c
                        ? b.addClass("alert-success")
                        : "warning" === c && b.addClass("alert-warning");
            });
        }
        function c() {
            var b = ["note", "beachte"],
                    ...
                    a(e).each(function (e, h) {
                        ...
                        null !== i.match(j) &&
                            (a.inArray(h, b) >= 0
                                ...
                                : a.inArray(h, c) >= 0
                                ? (k = "warning")
                                : a.inArray(h, d) >= 0 && (k = "hint"),
                            f.push({ p: g, alertType: k }));
                    });
                }),
                f
            );
    ...
    (function (a) {
        ...
        function b(b, c, d) {
            ...
            a.each(d.split(","), function (b, c) {
                g.push(a.trim(c)),
                    e.find("ol").append('<li data-target="#myCarousel" data-slide-to="' + b + '" class="active" /');
                var d;
                (d = 0 === b ? '<div class="active item"/>' : '<div class="item"/>'),
                    f.append(a(d).append('<img src="' + c + '"/>'));
            }),
                e.append(f),
    ...
    (function (a) {
        ...
        function b(b, c, d) {
            return (
                a().lazygist("init"),
                b.each(function (b, e) {
                    var f = { scheme: "https", path: "gist.github.com/" },
                        g = a.extend(f, c),
                        h = a(e),
                        i = a('<div class="gist_here" data-id="' + d + '" />');
                    h.replaceWith(i),
                        i.lazygist({
                            url_template: "{scheme}://{path}{id}.js"
                                .replace(/\{scheme\}/g, g.scheme)
                                .replace(/\{path\}/g, g.path),
                        });
                })
            );
        }
    ...
    (function (a, b, c, d) {
        ...
        function e(b) {
            ...
            if (-1 !== b.indexOf('rel="stylesheet"'))
                (f = a(b).attr("href")), -1 === a.inArray(f, k) && (a("head").append(b), k.push(f));
            else if (-1 !== b.indexOf('id="gist')) {
                if (
                    ((e = /https?:\/\/gist.*?\/.*\/(.*)#/.exec(b)),
                    null !== e ? (g = e[1]) : ((e = /gist\/.+?\/([a-f0-9]+)\/raw/g.exec(b)), null !== e && (g = e[1])),
                    g !== d)
                ) {
                ...
                load: function () {
                    return this.filter("[" + f.id + "]").each(function () {
                        ...
                        if (c !== d) {
                            ...
                            m.push(c),
                                (b = f.url_template.replace(/\{id\}/g, c).replace(/\{file\}/g, e)),
        ...
        (a.fn[g] = function (b) {
            return n[b]
                ? n[b].apply(this, Array.prototype.slice.call(arguments, 1))
                : "object" != typeof b && b
                ? void a.error("Method " + b + " does not exist on jQuery.lazygist")
    ...
    (function (a) {
        ...
        function b(b, c, d) {
            return b.each(function (b, d) {
                ...
                if ((g.attr("src", f), e.replaceWith(g), c.width && g.css("width", c.width), c.height))
    ...
    (function (a) {
        function b(b, c, d) {
            ...
            (e.type = "text/javascript"),
                (e.src = a.md.prepareLink("cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS-MML_HTMLorMML", {
                    forceSSL: !0,
                })),
        ...
        function b() {
            ...
            b.each(function () {
                var b = a(this),
                    c = b.attr("class"),
                    e = c.substring(5);
                d.indexOf(e) < 0 || (b.removeClass(c), b.addClass("language-" + e));
            }),
                Prism.highlightAll();
        }
        var c = {
    ...
    (function (a) {
        ...
        var b = [
                ...
                { name: "solar", url: "cdn.jsdelivr.net/npm/bootswatch@4.5.2/dist/solar/bootstrap.min.css" },
                { name: "darkly", url: "cdn.jsdelivr.net/npm/bootswatch@4.5.2/dist/darkly/bootstrap.min.css" },
            ],
            c = !1,
            d = {
                name: "Themes",
        ...
        var e = a.md.getLogger(),
            f = function (c) {
                ...
                ("bootstrap" === c.name && f) ||
                    (a("style[id*=bootstrap]").remove(),
                    a('<link rel="stylesheet" type="text/css">')
                        .attr("href", a.md.prepareLink(c.url))
                        .appendTo("head")),
                    c.inverse === !0
                        ? (a("#md-main-navbar").removeClass("navbar-default"),
                          a("#md-main-navbar").addClass("navbar-inverse"))
                        : (a("#md-main-navbar").addClass("navbar-default"),
                        ...
                        g.eq(0).text(f),
                            a.each(b, function (b, c) {
                                ...
                                a("<a/>")
                                    ...
                                    .click(function (a) {
                                        a.preventDefault(),
                                            (window.localStorage.theme = c.name),
    ...
    (function (a) {
        ...
        function b(b, c, d) {
            return b.each(function (b, d) {
                var f = {
                        chartType: "Line",
                        canvasId: "chartGimmick" + Math.floor(1e3 * Math.random() + 1),
                        chartOptions: { responsive: !1 },
                    },
                    g = a.extend({}, f, c),
                    h = a(d),
                    i = h.parents().find("table").last();
                if (0 === i.length) return e.error("Chart Gimmick: No tables found on the page."), void h.remove();
                var j = a('<canvas id="' + g.canvasId + '"></canvas>');
                j.width(g.width || "450px"), j.height(g.height || "250px"), h.replaceWith(j);
                var k = { datasets: [], labels: [] },
                    l = !0,
                    m = -1,
                    n = [];
                if (
                    (i.find("th").each(function (a) {
                        if (this.textContent === g.labelColumn) m = a;
                        else
                            for (var b = 0; b < g.dataColumns.length; b++)
                                this.textContent === g.dataColumns[b] && n.push(a);
                    }),
                    i.find("tr").each(function (b) {
                        a(this)
                            .find("td")
                            .each(function (a) {
                                if (a === m) k.labels.push(this.textContent);
                                else
                                    for (var b = 0; b < n.length; b++)
                                        a === n[b] &&
                                            (void 0 === k.datasets[b] &&
                                                ((k.datasets[b] = {}), (k.datasets[b].data = [])),
                                            k.datasets[b].data.push(this.textContent));
                            });
                    }),
                    void 0 === k.datasets[b] &&
                        ((l = !1),
                        e.error(
                            "Chart Gimmick: No data was found for the chart. Make sure that there is a tables on the page. Check that your column headers match the chart configuration."
                        )),
                    l)
                ) {
                    var o = document.getElementById(g.canvasId),
                        p = o.getContext("2d");
                    a.md.stage("postgimmick").subscribe(function (a) {
                        setTimeout(function () {
                            new Chart(p)[g.chartType](k, g.chartOptions);
                        }),
                            a();
                    });
                }
        ...
        var c = "//cdnjs.cloudflare.com/ajax/libs/Chart.js/1.0.2/Chart.min.js",
            d = {
                name: "chart",
                version: a.md.version,
                once: function () {
                    a.md.linkGimmick(this, "chart", b),
                        a.md.registerScript(this, c, {
                            license: "MIT",
    ...
    (function (a) {
        "use strict";
        function b(b, c, d) {
            var e = { type: "class", style: "plain", direction: "LR", scale: "100" },
                f = a.extend({}, e, c);
            return b.each(function (b, c) {
                var d = a(c),
                    e = "http://yuml.me/diagram/",
                    g = d.attr("href"),
                    h = d.attr("title");
                (h = h ? h : ""),
                    (g = g.replace(new RegExp("`", "g"), "(").replace(new RegExp("´", "g"), ")")),
                    (e += f.style + ";dir:" + f.direction + ";scale:" + f.scale + "/" + f.type + "/" + g);
                var i = a('<img src="' + e + '" title="' + h + '" alt="' + h + '">');
                d.replaceWith(i);
            });
        }
        var c = {
            ...
            version: a.md.version,
            once: function () {
                a.md.linkGimmick(this, "yuml", b),
                    a.md.registerScript(this, "", {
                        license: "LGPL",
