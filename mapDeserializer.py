...
def deserialize_map_chunk(node: Dict[str, any], tile_map: Dict[int, str], chunk_size: int = 16) -> MapChunk:
...
print("Original tiles == Serializado tiles:", serialized_chunk["tiles"] == chunk_data["tiles"])
